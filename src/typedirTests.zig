...
const insert = typedir.insert;
const get = typedir.get;
const update = typedir.update;
const delete = typedir.delete;
const liveCount = typedir.liveCount;
const getLink = typedir.getLink;
const setLink = typedir.setLink;
const backlinkCount = typedir.backlinkCount;
const linkSetAdd = typedir.linkSetAdd;
const linkSetContains = typedir.linkSetContains;
const resolveLink = typedir.resolveLink;
const getLinked = typedir.getLinked;
const deleteNullifyX = typedir.deleteNullifyX;
